...
b][g])?(a[e][g]-c)/c*100:null;c=[d[e],c];k.push(c);l.push(c[0]);m.push(c[1])}return{values:k,xData:l,yData:m}}}}f.defaultOptions=n(d.defaultOptions,{params:{index:3,period:9}});p(f.prototype,{nameBase:"Rate of Change"});a.registerSeriesType("roc",f);"";return f});b(a,"masters/indicators/roc.src.js",[],function(){})});//# sourceMappingURL=roc.js.map