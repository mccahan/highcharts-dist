...
k.push(f[0]),l.push(f[1]);f=[e[d-1],a[d-1][b]-a[d-c-1][b]];h.push(f);k.push(f[0]);l.push(f[1]);return{values:h,xData:k,yData:l}}}}e.defaultOptions=n(c.defaultOptions,{params:{index:3}});g(e.prototype,{nameBase:"Momentum"});a.registerSeriesType("momentum",e);"";return e});b(a,"masters/indicators/momentum.src.js",[],function(){})});//# sourceMappingURL=momentum.js.map