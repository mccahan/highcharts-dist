...
tooltip:{pointFormat:"Lat: {point.lat}, Lon: {point.lon}, Value: {point.value}<br/>"},borderWidth:0,colsize:1,rowsize:1});k(e.prototype,{type:"geoheatmap",pointClass:b,pointArrayMap:["lon","lat","value"]});a.registerSeriesType("geoheatmap",e);"";return e});c(a,"masters/modules/geoheatmap.src.js",[],function(){})});//# sourceMappingURL=geoheatmap.js.map